...
PROFILE_META_DISTRO_1 = _('Seleccione la Metadistribución base de sabor:')
PROFILE_META_DISTRO_2 = _('Seleccione la Metadistribución que será la base del sabor en construcción.')
