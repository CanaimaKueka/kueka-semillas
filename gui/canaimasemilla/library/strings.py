...
PROFILE_NOMBRE_SABOR_1 = _('Introduzca el nombre del sabor a crear:')
PROFILE_NOMBRE_SABOR_2 = _('Debe introducir el nombre con el que desea identificar la distribución derivada que está creando, en minúsculas y sin espacios.')
PROFILE_NOMBRE_AUTOR_1 = _('Introduzca el nombre de la persona o grupo responsable:')
PROFILE_NOMBRE_AUTOR_2 = _('Debe introducir el nombre de la persona o grupo responsable de la creación y mantenimiento del sabor.')
PROFILE_CORREO_AUTOR_1 = _('Introduzca el correo electrónico de la persona o grupo responsable:')
PROFILE_CORREO_AUTOR_2 = _('Debe introducir un correo electrónico válido para contacto de la persona o grupo responsable de la creación y mantenimiento del sabor.')
PROFILE_WEB_AUTOR_1 = _('Introduzca una dirección web para la persona o grupo responsable:')
PROFILE_WEB_AUTOR_2 = _('Puede introducir una dirección web de referencia para mayor información acerca del sabor.')
...
PROFILE_OS_EXTRAREPOS_2 = _('Los repositorios adicionales permiten agregar software no oficial o desarrollado localmente a la imagen en construcción.')
PROFILE_OS_EXTRAREPOS_CHECK = _('Deseo incluir repositorios adicionales')
PROFILE_OS_EXTRAREPOS_URL = _('Dirección web')
PROFILE_OS_EXTRAREPOS_RAMA = _('Rama')
PROFILE_OS_EXTRAREPOS_SECCION = _('Secciones')
