...
PROFILE_OS_EXTRAREPOS_VALIDATE_URL = _('Validando dirección web del repositorio ...')
...
PROFILE_OS_EXTRAREPOS_VALIDATE_PKGS = _('Validando estructura y consistencia del repositorio ...')
